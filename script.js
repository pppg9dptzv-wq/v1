...
const tricksByCategory = {
    ...
    'super tricks': ['frontflip', '720', '900', 'oa frontflip', 'delchev', 'menendes', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', '1080', '1260', 'back to back regrab', 'front to front regrab'],
    'flyaways': ['back', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back full', 'back double full'],
    'power moves': ['planche', 'front lever', 'back lever', 'hefesto']
};
        
const originalItems = ['muscle-up', 'planche', 'front lever', 'back lever', 'hefesto', 'barspin', '360', '180', '540', 'laizans', 'back', 'shrimp flip', 'giant swing', 'frontflip', 'oa frontflip', 'delchev', 'geinger', 'frisbee', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?'];
        
    const compatibilities = {
    'muscle-up': ['barspin', 'planche', 'hefesto', '360', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '180': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '360': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '540': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '720': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '900': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '1080': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    '1260': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'barspin': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'laizans': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'shrimp flip': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'giant swing': ['front lever', 'back lever', 'planche', 'laizans', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'menendes': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'oa frontflip': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'frontflip': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'delchev': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'frisbee': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'geinger': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'back to back regrab': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'front to front regrab': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'front lever': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'back lever': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'planche': ['front lever', 'back lever', 'hefesto', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'hefesto': ['front lever', 'back lever', 'muscle-up', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'king 360': ['front lever', 'back lever', 'laizans', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'king 540': ['front lever', 'back lever', 'laizans', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'king 720': ['front lever', 'back lever', 'laizans', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'king 900': ['front lever', 'back lever', 'laizans', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'king 1260?': ['front lever', 'back lever', 'laizans', '180', '360', 'shrimp flip', '540', 'geinger', 'frisbee', 'giant swing', 'delchev', 'frontflip', 'oa frontflip', 'menendes', '720', '900', '1080', '1260', 'back to back regrab', 'front to front regrab', 'king 360', 'king 540', 'king 720', 'king 900', 'king 1260?', 'back', 'back full', 'front', 'front full', 'back to back', 'front to front', 'double back', 'back double full'],
    'double back': [],
    'back double full': [],
    'back': [],
    'back full': [],
...
const trickInfo = {
    ...
    'back to back regrab': { text: 'zone under construction: we need volunteers for the example videos, contact us :)', video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
    'front to front regrab': { text: 'zone under construction: we need volunteers for the example videos, contact us :)', video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
    ...
    'back to back': { text: 'zone under construction: we need volunteers for the example videos, contact us :)', video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
    'front to front': { text: 'zone under construction: we need volunteers for the example videos, contact us :)', video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
};
